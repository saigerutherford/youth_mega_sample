function [y_predict_reshape,randinds,pmask_hold]=cpm_cv(x,y,pthresh,kfolds,varargin)
...
for leftout = 1:kfolds
    ...
    [r,p,pmask,mdl] = cpm_train(x_train, y_train,pthresh,'corrtype',corrtype,'z',z_train);
