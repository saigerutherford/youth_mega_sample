function [y_predict, performance,randinds,pmask_hold] = cpm_main_nonlin(x,y,varargin)
...
%% Check for errors
[x,y]=cpm_check_errors_nonlin(x,y,kfolds);

%% Train & test Connectome-Based Predictive Model
[y_predict,randinds,pmask_hold]=cpm_cv_nonlin(x,y,pthresh,kfolds,'corrtype',corrtype,'z',z); 
