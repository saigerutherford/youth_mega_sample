function [r,p,pmask,mdl]=cpm_train_nonlin(x,y,pthresh,varargin)
...
% Fit y to summary features - CH - 11-10-18 -using a quadratic fxn.
mdl=polyfit(summary_feature,y',2);    